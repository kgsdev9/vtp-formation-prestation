<section class="py-xl-8 py-6">
    <div class="container">
      ...
      <div class="position-relative">
        ...
        <div class="tns-outer" id="tns1-ow"><div class="tns-liveregion tns-visually-hidden" aria-live="polite" aria-atomic="true">slide <span class="current">8</span>  of 10</div><div id="tns1-mw" class="tns-ovh"><div class="tns-inner" id="tns1-iw"><div class="sliderFirst py-3  tns-slider tns-carousel tns-subpixel tns-calc tns-horizontal" id="tns1" style="transform: translate3d(-35%, 0px, 0px);"><div class="item tns-item tns-slide-cloned" aria-hidden="true" tabindex="-1">
          ...
          <div class="item tns-item" id="tns1-item8" aria-hidden="true" tabindex="-1">
            <div class="card card-lift">
              <a href="#!">
                <img src="assets/images/course/nuxt.jpg" alt="figma" class="card-img-top img-fluid w-100">
              </a>
          ...
          <div class="item tns-item" id="tns1-item9" aria-hidden="true" tabindex="-1">
            <div class="card card-lift">
              <a href="#!">
                <img src="assets/images/course/bootstrap.jpg" alt="figma" class="card-img-top img-fluid w-100">
              </a>
