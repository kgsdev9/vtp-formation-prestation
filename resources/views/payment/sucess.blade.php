...
<div class="card mt-4">
    <div class="card-body">
        <div class="mb-4">
            <h2 class="mb-0">Votre Commande est validée  </h2>
           <p>Votre commande est validée , vous allez recevoir les details de la formation et le contenu.</p>
        </div>
        <a href="{{route('orders.users.liste')}}" class="btn btn-outline-secondary">
