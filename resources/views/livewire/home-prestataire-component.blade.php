                    ...
                    <div class="col-12">
                        <div class="d-flex flex-column gap-5">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <p class="mb-0">Nos Formateurs sont vérifiés et ont des compétences requises pour vos projets.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xxl-3 col-lg-4 col-12">
                        <div class="d-flex flex-column">
                            <div class="d-flex flex-row align-items-center justify-content-between mt-2 mb-3">
                                ...
                                <div>
                                    <button wire:click="resetFilters" class="btn btn-light border btn-sm">
                                        <span>Clear</span>
                                        <span>
                                                ...
                                                <ul class="list-unstyled mb-1 d-flex flex-column gap-1 mt-3">
                                                    ...
                                                    <li class="d-flex flex-row gap-2">
                                                        <div class="form-check">
                                                            <input class="form-check-input filter-checkbox" type="checkbox" value="{{ $vallTags->id }}" wire:model="selectedTags">
                                                            <label class="form-check-label text-secondary">{{ $vallTags->libelletypeprestation }}</label>
                                                        </div>
                                                    </li>
                                                    @endforeach
                                                </ul>
                                                <div class="mt-3">
                                                    <a class="btn-collapse fw-semibold" data-bs-toggle="collapse" href="#collapseContent" aria-expanded="false" aria-controls="collapseContent">
                                                        Consulter
                    ...
                    <div class="col-xxl-9 col-lg-8 col-12">
                                    ...
                                    <div class="card rounded-4 card-bordered card-lift">
                                      <div class="p-3 d-flex flex-column gap-3">
                                        ...
                                        <a href="{{route('detail.prestataire', $vallFormateurs->id)}}">
                                          <img src="{{asset('assets/images/avatar/avatar-1.jpg')}}" alt="mentor 1" class="img-fluid w-100 rounded-4">
                                        </a>
                                        <!--content-->
                                        <div class="d-flex flex-column gap-4">
                                          <div class="d-flex flex-column gap-2">
                                            <div>
                                              ...
                                              <span class="text-gray-800">{{$vallFormateurs->typeprestation->libelletypeprestation?? 'rienss'}}</span>
                                            </div>
                        ...
                        <div class="mt-4">
                            {{ $allFormateurs->links() }} <!-- Pagination -->
                        </div>
                    </div>
                </div>
            </div>
