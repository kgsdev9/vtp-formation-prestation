                ...
                <div class="d-flex gap-2 align-items-center">
                    ...
                    <a href="{{route('dashboard.users')}}" class="btn btn-outline-dark btn-sm">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-fill" viewBox="0 0 16 16">
                          ...
                          </svg>  Tableau de bord {{Auth::user()->
                        name}}
                    </a>
                    <a href="{{route('become.teacher')}}" class="btn btn-dark d-none d-md-block btn-sm"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-in-right" viewBox="0 0 16 16">
...
<script>
    $(document).ready(function() {
        $('#skills').select2({
            placeholder: "Selectionner des skills",
            allowClear: true,
            width: '100%'
