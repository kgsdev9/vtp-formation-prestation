...
<html lang="en">
	...
	<body class="bg-light">
					...
					<div class="col-lg-5">
						<div class="rounded-3 bg-white shadow-sm p-5 text-center">
							...
							<p class="text-muted fw-light mb-4">
								Enter the email address you see
								<br>
								 on Edutree. We'llsend you a link to reset your password
							</p>
							<form action="signin.html" class="d-grid gap-3 mb-2">
								<input type="text" class="form-control" placeholder="Enter Email">
								<button type="submit" class="btn btn-primary">RESET PASSWORD</button>
							</form>
							<p class="text-muted mt-3 mb-0">
								Go back to 
								<a href="signin.html" class="text-mdinfo">Sign In</a>
							</p>
						</div>
					</div>
				</div>
		...
		<script defer src="https://static.cloudflareinsights.com/beacon.min.js/v52afc6f149f6479b8c77fa569edb01181681764108816" integrity="sha512-jGCTpDpBAYDGNYR5ztKt4BQPGef1P0giN6ZGVUi835kFF88FOmmn8jBQWNgrNd8g/Yu421NdgWhwQoaOPFflDw==" data-cf-beacon='{"rayId":"7df4bb65682900c6","version":"2023.4.0","r":1,"token":"dd471ab1978346bbb991feaa79e6ce5c","si":100}' crossorigin="anonymous"></script>
	</body>
