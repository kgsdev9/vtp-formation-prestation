	...
	<body class="bg-light">
		...
		<div class="py-2">
			<div class="container p-5 mb-lg-5 text-center">
				...
				<p class="lead mb-5">
					Check your courses status in 
					<a class="text-primary" href="instructor-my-courses.html">My Courses</a>
					<br>
					 about next steps information.
				</p>
				<a href="instructor-my-courses.html" class="btn btn-primary"><i class="bi bi-gift me-2"></i> Start Learning</a>
			</div>
		</div>
		...
		<script defer src="https://static.cloudflareinsights.com/beacon.min.js/v52afc6f149f6479b8c77fa569edb01181681764108816" integrity="sha512-jGCTpDpBAYDGNYR5ztKt4BQPGef1P0giN6ZGVUi835kFF88FOmmn8jBQWNgrNd8g/Yu421NdgWhwQoaOPFflDw==" data-cf-beacon='{"rayId":"7defa8da68ac0062","version":"2023.4.0","r":1,"token":"dd471ab1978346bbb991feaa79e6ce5c","si":100}' crossorigin="anonymous"></script>
	</body>
